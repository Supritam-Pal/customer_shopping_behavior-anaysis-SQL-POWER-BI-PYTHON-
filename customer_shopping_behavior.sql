...
select top 5 Item_Purchased, AVG(CAST(Review_Rating AS DECIMAL(10, 2))) as "Average Product Rating"
from customer
...
SET Age_Group =
    CASE
        ...
        WHEN Age BETWEEN 26 AND 40 THEN 'Working Age'
        WHEN Age BETWEEN 41 AND 55 THEN 'Mature Adult'
